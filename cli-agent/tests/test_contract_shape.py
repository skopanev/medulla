"""The contract: the file's own shape — version, start, vars, duplicate keys.

Every rule here fails at LOAD time. A workflow is code, and code that parses but means
